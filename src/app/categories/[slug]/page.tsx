    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 mx-auto max-w-6xl w-full px-4 sm:px-6 py-12">
        <section className="mb-12">
          <h1 className="text-3xl sm:text-4xl font-bold tracking-tight mb-2">{category.name}</h1>
        ...
        {posts.length > 0 ? (
          ...
          <p className="text-zinc-500 py-12 text-center">No posts in this category yet.</p>
        )}
      </main>
    </div>
  );
