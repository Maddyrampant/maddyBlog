...
export default function DigitechPostPage({
  post,
  commentTree,
  commentCount,
}: PostPageProps) {
  return (
    <main className="flex-1 mx-auto max-w-4xl w-full px-4 sm:px-6 py-12">
      <article>
        <header className="mb-12">
          ...
          <div
            ...
            style={{
              ...
              borderBottom: "1px solid var(--digitech-border)",
            }}
          >
            <span
        ...
        {post.coverImage && (
          <div className="aspect-[2/1] overflow-hidden rounded-2xl mb-12 relative digitech-card">
            <Image
              src={post.coverImage}
              alt={post.title}
              fill
        ...
        <div
          ...
          style={
            {
              "--tw-prose-body": "var(--digitech-text)",
              "--tw-prose-headings": "var(--digitech-text)",
              "--tw-prose-links": "var(--digitech-accent)",
              "--tw-prose-bold": "var(--digitech-text)",
              "--tw-prose-quotes": "var(--digitech-text)",
              "--tw-prose-quote-borders": "var(--digitech-accent)",
              "--tw-prose-code": "var(--digitech-neon)",
              "--tw-prose-pre-bg": "var(--digitech-card-bg)",
              "--tw-prose-hr": "var(--digitech-border)",
              "--tw-prose-th-borders": "var(--digitech-border)",
        ...
        {commentTree && commentTree.length > 0 ? (
          <div className="space-y-6">
            {commentTree.map((comment) => (
              <div key={comment.id} className="digitech-card p-5">
                <div
                      ...
                      <div key={reply.id}>
                        ...
                        >
                          ...
                          <span
                            className="w-1 h-1 rounded-full"
                            style={{
                              background: "var(--digitech-text-muted)",
                            }}
                          />
                          <time>
          ...
          <p style={{ color: "var(--digitech-text-muted)" }}>
            No comments yet. Be the first to share your thoughts!
          </p>
        )}
      </section>

      <hr className="digitech-divider mt-12" />
    </main>
  );
}
