...
export default function GameverseHeader({}: HeaderProps) {
  const [menuOpen, setMenuOpen] = useState(false);

  return (
    <header
      className="sticky top-0 z-50 gameverse-glass"
      style={{ borderBottom: "1px solid var(--gameverse-neon-purple)" }}
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-4 flex items-center justify-between">
        <Link
          href="/"
          className="text-xl font-black tracking-tight gameverse-gradient-text"
        >
          GameVerse
        </Link>
