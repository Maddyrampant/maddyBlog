...
export default function ZoomjiCommentList({ comments }: CommentListProps) {
  if (comments.length === 0) {
    return <p style={{ color: "var(--zoomji-text-muted)" }}>No comments yet.</p>;
  }
...
function CommentItem({ comment, depth }: { comment: Comment; depth: number }) {
  return (
    <div
      ...
      style={depth > 0 ? { borderLeft: "1px solid var(--zoomji-border)" } : undefined}
    >
      <div className="zoomji-card p-5">
