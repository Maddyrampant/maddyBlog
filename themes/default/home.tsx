...
type HomePageProps = {
  ...
  trending: Array<{ id: string; title: string; slug: string; views: number; commentCount: number }>;
  popularTags: Array<{ id: string; name: string; slug: string; postCount: number }>;
};
